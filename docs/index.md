---
layout: default
title: Tiation Rigger Infrastructure - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Rigger Infrastructure</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-rigger-infrastructure" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
![Architecture Diagram](../assets/architecture/tiation-rigger-infrastructure-architecture.svg)
...
```bash
# Build Docker image
docker build -t tiation-rigger-infrastructure .

# Run container
docker run -p 8080:8080 tiation-rigger-infrastructure
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-rigger-infrastructure)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-rigger-infrastructure/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-rigger-infrastructure/discussions)
